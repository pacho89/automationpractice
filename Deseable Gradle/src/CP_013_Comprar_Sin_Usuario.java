...
public class CP_013_Comprar_Sin_Usuario {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("email_create")).sendKeys("emailprueba3ssssss3213ss@gmail.com");
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div[3]/div/form/p/button/span")).click();
		Thread.sleep(5000);
		String ConfirmationText=driver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div/div/p/strong")).getText();
